...
public class AdminConstant {
	...
	public static final String APPROVE_FAIL = "";
	public static final String APPROVE_SUCCESS = "Failed to Approve";
	public static final String REJECT_FAIL = "Failed to reject";
